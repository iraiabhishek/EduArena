                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <div class="col-lg-6 col-lg-offset-3">
                                                    <button formaction="../UpdateProfile" type="submit" class="btn btn-warning">Update Profile</button>
                                                    ...
                                                    <button formaction="../DeleteAccount" type="submit" class="btn btn-danger">Delete Account</button>
                                                </div>
                                            </div><!--end form group-->
                                        </div>
                                    </div>
