                            ...
                            <div class="panel-body text-left">
                                <form action="" class="form-horizontal">
                                    ...
                                    <div class="form-horizontal col-lg-offset-4">    
                                        <div class="form-group">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-warning" formaction="AspEditProfile.jsp">Edit Profile</button>
                                                <button type="submit" class="btn btn-warning" formaction="AspChngPwd.jsp">Change Password</button>
                                            </div>						
                                        </div>
                                    </div>
                            </form>                                
