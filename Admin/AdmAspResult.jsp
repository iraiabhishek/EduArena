<%-- 
    Document   : AdmAspResult
    Created on : Apr 14, 2019, 6:32:27 PM
    Author     : Abhishek Rai
--%>
                                ...
                                <div class="form-group"><br>
                                    <div class="panel panel-heading panel-primary col-lg-10 col-lg-offset-1">
                                        <%
                                            ...
                                            //Counting total rows
                                            int paperid=Integer.valueOf(request.getParameter("view"));
//                                            String email=((String)ud.get("email")).replace("@gmail.com", "");
                                            ...
                                            int pid=0;
                                            String em="";
                                            ResultSet rs=stmt.executeQuery("Select email,paperid from examresults where email='"+request.getParameter("view")+"' and paperid='"+Integer.valueOf(request.getParameter("view"))+"' ");
                                            if(rs.next()){
                                                em=rs.getString(1);
                                                pid=rs.getInt(2);
                                            }
