<%-- 
    ...
    Created on : Apr 13, 2019, 5:43:27 PM
    Author     : Abhishek Rai
--%>
                                ...
                                <form action="" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10 col-lg-offset-4">
                                            ...
                                            <button type="submit" value='<%=aspfac.get("email")%>' name="email" class="btn btn-danger" formaction="../DeleteAspAdm" onclick="return confirm('Click on OK button to delete this account.');">Delete Account</button>
                                        </div>
                                    </div>            
                                </form>
                            </div>
                        ...
                        <div class="panel panel-default panel-danger">
                            ...
                            <div class="panel-body text-left">
                                <form action="" class="form-horizontal">
                                    <div class="panel panel-default panel-warning">
                                        <div class="panel-heading">
                                            <b><h4 class="text-center">ATTEMPTED</h4></b>
                                        </div>
                                        <div class="panel-body">
                                            <div class="form-horizontal">    
                                                <%
                                                    ...
                                                    int i=0;
                                                    stmt=db.getSt();
                                                    ResultSet res=stmt.executeQuery("Select SUB,paperid from examresults where Email='"+((String)aspfac.get("email"))+"' ");
                                                    while(res.next()){
                                                        i++ ;
                                                %>
                                                        <div class="col-lg-1">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <div class="form-group">
                                                                <label for="sub" class="control-label"><b><%=res.getString(1)%></b></label>
                                                            </div><!--end form group-->
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <input type="hidden" id="pid" name="pid" value='<%=res.getString(2)%>' />
                                                                <!--The hidden field is not shown to the user, but the data is sent when the form is submitted.-->
                                                                <button type="submit" value='<%=res.getString(2)%>' name="view" class="btn btn-dark" formaction="AdmAspResult.jsp">View</button>
                                                                <button type="submit" value='<%=aspfac.get("email")%>' name="email" class="btn btn-danger" formaction="../DeleteAspExamAdm" onclick="return confirm('Click on OK button to delete this paper record completely for this aspirant. i.e. Regisration, Result and Responsed Answers.');">Delete</button>
                                                            </div>						
                                                        </div>
                                                <%
                                                    }
                                    ...
                                    <div class="panel panel-default panel-warning">
                                        <div class="panel-heading">
                                            <b><h4 class="text-center">REGISTERED</h4></b>
                                        </div>
                                        <div class="panel-body">
                                            <div class="form-horizontal">    
                                                <%
                                                    ...
                                                    i=0;
                                                    stmt=db.getSt();
                                                    res=stmt.executeQuery("Select * from examapplicants where Status!='Completed' and Email='"+((String)aspfac.get("email"))+"' ");
                                                    while(res.next()){
                                                        i++ ;
                                                %>
                                                        <div class="col-lg-1">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <div class="form-group">
                                                                <label for="sub" class="control-label"><b><%=res.getString(4) %></b></label>
                                                            </div><!--end form group-->
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <input type="hidden" id="pid1" name="pid1" value='<%=res.getString(3)%>' />
                                                                <!--The hidden field is not shown to the user, but the data is sent when the form is submitted.-->
                                                                <button type="submit" value='<%=aspfac.get("email")%>' name="email1" class="btn btn-danger" formaction="../DeleteAspExamRegAdm" onclick="return confirm('Click on OK button to delete this paper record completely for this aspirant. i.e. Regisration, Result and Responsed Answers.');">Delete</button>
                                                            </div>						
                                                        </div>
                                                <%
                                                    }
