<%-- 
    Document   : AdmEditProfile
    Created on : Mar 16, 2019, 11:54:36 PM
    Author     : Abhishek Rai
--%>
                    ...
                    <div class="panel panel-default panel-danger">
                        <div class="panel-heading text-center">
                            <div class="row">
                                ...
                                <form action="../UpdatePhotoAdm" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <div class="col-lg-6 col-lg-offset-3">
                                                    <button formaction="../UpdateProfileAdm" type="submit" class="btn btn-warning">Update Profile</button>
                                                    ...
                                                    <button formaction="../DeleteAccountAdm" type="submit" class="btn btn-danger">Delete Account</button>
                                                </div>
                                            </div><!--end form group-->
                                        </div>
                                    </div>
