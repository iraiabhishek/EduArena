<%-- 
    Document   : FacProfile
    Created on : Mar 17, 2019, 2:54:19 AM
    Author     : Abhishek Rai
--%>
                            ...
                            <div class="panel-body text-left">
                                <form action="" class="form-horizontal">
                                    ...
                                    <div class="form-horizontal col-lg-offset-4">    
                                        <div class="form-group">
                                            <div class="form-group">
                                            <button type="submit" class="btn btn-warning" formaction="FacEditProfile.jsp">Edit Profile</button>
                                            <button type="submit" class="btn btn-warning" formaction="FacChngPwd.jsp">Change Password</button>
                                        </div>						
                                    </div>
                                </div>
                            </form>                                
