<%-- 
    Document   : LogFaculty
    Created on : Mar 16, 2019, 1:28:46 PM
    Author     : Abhishek Rai
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <%
                        ...
                        if(ud!=null){
                    %>
                            <li><a href="../Aspirant/AspProfile.jsp"><%=ud.get("name")%></a></li>
                            <li><a href="../Logout">Logout</a></li>
                    <%
                        }else{
                    %>
                            <%--
                                <li><a class="navbar-brand" href="FacRegister.jsp">Faculty[+]</a></li>
                            --%>
                    ...
                    <div class="col-lg-6 col-lg-offset-3">
                        <div class="panel panel-default panel-title">
                            ...
                            <div class="panel-body">
                                <form action="../LoginProcessFac" method="post" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10 col-lg-offset-3">
                                            <a href="../forgetpassword.jsp">Forget Password ?</a> | <a href="FacRegister.jsp">Sign Up</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
